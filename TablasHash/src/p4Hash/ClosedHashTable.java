...
//	No cambiar el nombre ni visibilidad de los atributos protected
	...
	//REDISPERSION aumentar el tama�o de la tabla hash para evitar colisiones LF >=0.5
...
//			pos = funcionDistribucion(elem, intento);
	...
	public T find(T elem) {
		...
		T prueba = tabla[posicion].getInfo();
		while(!tabla[posicion].getInfo().equals(elem) || iteracion == numElems) {
